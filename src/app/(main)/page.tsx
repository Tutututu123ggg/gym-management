...
// Ảnh Demo từ Unsplash (Giữ nguyên)
...
export default function HomePage() {
  return (
    // SỬA: Dùng bg-background và text-foreground để theme tự đổi
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-[600px] md:h-[750px] flex items-center justify-center text-center px-4">
        {/* Lớp phủ tối để chữ dễ đọc hơn (Giữ nguyên vì là hiệu ứng ảnh) */}
        ...
        <div className="relative z-20 max-w-5xl mx-auto flex flex-col items-center animate-fade-in-up">
          ...
          {/* SỬA: Thay text-gray-300 bằng text-primary-foreground (màu chữ sáng khi nền tối) */}
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Link 
              href="/plans" 
              // SỬA: Dùng bg-primary và hover:bg-primary/90 để lấy màu primary
            ...
            <Link
              href="/about"
              className="px-8 py-4 bg-transparent backdrop-blur-md border border-white text-white hover:bg-white hover:text-black rounded-full font-bold text-lg transition-all flex items-center justify-center"
            >
              Tìm Hiểu Thêm
            </Link>
      ...
      <section 
        // SỬA: Dùng bg-card và border-border
        className="py-10 bg-card border-b border-border"
      >
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            {/* SỬA: Màu chữ dựa trên primary-foreground/foreground */}
            <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">2000m²</p>
            <p className="text-muted-foreground text-sm uppercase">Diện tích sàn</p>
          </div>
          <div>
            <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">50+</p>
            <p className="text-muted-foreground text-sm uppercase">HLV Chuyên nghiệp</p>
          </div>
          <div>
            <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">24/7</p>
            <p className="text-muted-foreground text-sm uppercase">Mở cửa</p>
          </div>
          <div>
            <p className="text-3xl md:text-4xl font-bold text-foreground mb-1">15k+</p>
            <p className="text-muted-foreground text-sm uppercase">Hội viên tin tưởng</p>
          </div>
        </div>
      </section>

      {/* --- FEATURES (fixed icons + dark-safe classes) --- */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
              Tại Sao Chọn Gym Master?
            </h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto text-lg">
              Không chỉ là phòng tập — đây là hệ sinh thái sức khỏe hoàn chỉnh.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group">
              <div className="w-16 h-16 bg-blue-50 dark:bg-blue-900/30 rounded-2xl flex items-center justify-center mb-6 transition-colors group-hover:bg-blue-600">
                {/* SVG icon (static classes) */}
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-blue-600 dark:text-blue-300 group-hover:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Trang thiết bị Technogym & LifeFitness đời mới, độ bền cao và an toàn tuyệt đối.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group">
              <div className="w-16 h-16 bg-green-50 dark:bg-green-900/30 rounded-2xl flex items-center justify-center mb-6 transition-colors group-hover:bg-green-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-green-600 dark:text-green-300 group-hover:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                HLV chứng chỉ quốc tế, kèm cặp tận tâm theo lộ trình chuyên sâu.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700 group">
              <div className="w-16 h-16 bg-purple-50 dark:bg-purple-900/30 rounded-2xl flex items-center justify-center mb-6 transition-colors group-hover:bg-purple-600">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-purple-600 dark:text-purple-300 group-hover:text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Mở từ 5h đến 23h, check-in FaceID nhanh chóng.
              </p>
            </div>
          </div>
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-10">
            <div>
              ...
              <p className="text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                View thành phố cực chill, hệ thống máy chạy tích hợp màn hình giải trí Netflix/Youtube.
              </p>
            </div>
          </div>
        </div>
        <div className="relative h-[400px] md:h-[600px] group overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-10">
            <div>
              ...
              <p className="text-muted-foreground opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                Đầy đủ các mức tạ từ 2kg đến 50kg, sàn tập chuẩn Olympic chống chấn thương.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* SỬA: Dùng bg-primary, text-primary-foreground và các biến liên quan */}
      <section className="py-24 bg-primary text-primary-foreground text-center px-4 relative overflow-hidden">
        {/* Họa tiết trang trí nền (Giữ nguyên màu cứng cho hiệu ứng gradient) */}
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Đừng Chờ Đợi Phiên Bản Hoàn Hảo <br />
            <span>Hãy Bắt Đầu Để Trở Nên Hoàn Hảo</span>
          </h2>
          {/* SỬA: text-primary-foreground/80 */}
          <p className="text-xl text-primary-foreground/80 mb-10">
            Đăng ký ngay hôm nay để nhận gói tập thử miễn phí 7 ngày cùng Huấn luyện viên cá nhân.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <Link href="/plans" className="px-10 py-5 bg-primary-foreground text-primary hover:bg-white rounded-full font-bold text-xl shadow-xl transition-transform hover:-translate-y-1">
               Xem Bảng Giá Gói Tập
             </Link>
             <button className="px-10 py-5 bg-transparent border border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground/10 rounded-full font-bold text-xl transition-all">
               Liên Hệ Tư Vấn
             </button>
          </div>
        </div>
      ...
      <footer className="bg-card text-muted-foreground py-12 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-foreground font-bold text-xl mb-4">Gym Master</h3>
            <p>Hệ thống phòng tập 5 sao hàng đầu Việt Nam.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/plans" className="hover:text-primary">Gói tập</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-foreground font-bold mb-4">Hỗ trợ</h4>
            <ul className="space-y-2">
          ...
          <div>
             ...
             <p>Email: support@gymmaster.vn</p>
             <p>Địa chỉ: 123 Đường ABC, Quận Cầu Giấy, Hà Nội</p>
          </div>
        </div>
        <div className="text-center pt-8 border-t border-border">
          <p>© {new Date().getFullYear()} Gym Master. All rights reserved.</p>
        </div>
      </footer>
