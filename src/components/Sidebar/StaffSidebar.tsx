...
// Import Lucide Icons
import { 
  Home, Users, CreditCard, Dumbbell, 
  MessageSquare, LogOut, Menu, X, Sun, Moon
} from 'lucide-react';
...
const StaffSidebar = () => {
  ...
  // Menu riêng cho Staff dựa trên hierarchy đã cung cấp
  const staffMenuItems: MenuItem[] = [
    { name: 'Trang chủ', href: '/staff/home', icon: Home },
    { name: 'Hội viên', href: '/staff/members', icon: Users },
    { name: 'Gói tập', href: '/staff/plans', icon: CreditCard },
    { name: 'Thiết bị', href: '/staff/equipment', icon: Dumbbell },
    { name: 'Phản hồi', href: '/staff/feedbacks', icon: MessageSquare },
  ];
